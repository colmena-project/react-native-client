...
const SplashEnd = props => {
    const dispatch = useDispatch();
    const handleHome = () => {
        dispatch(setSeeSplash(true));
    };
    const handleSwipeRight = () => {
        props.navigation.navigate('SplashSecond');
    }; 
    return (
        <GestureRecognizer
            flex={1}
            ...
            <View style={{ flex: 1, backgroundColor: colors.colmenaBackground }}>
                ...
                <View alignItems = {'center'} style={{height:150, backgroundColor: colors.colmenaBackground}}>
                    <View alignItems = {'center'}>
                        <Text style={{fontSize:22, fontFamily: 'Nunito-Regular'}}>Obtené Beneficios</Text>
                    </View>
                    <View alignItems = {'center'} style={{width:'80%'}}>
                        <Text style={{color: '#999999', fontSize:14, textAlign:'center', fontFamily: 'Nunito-Regular'}}>Tu trabajo recibe una compensación económica mediante la criptomoneda JellyCoin</Text>
                    </View>                
                    <View flexDirection="row" style={{padding:20}} justifyContent="space-between">
