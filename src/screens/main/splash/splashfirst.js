            ...
            <View style={{ flex: 1, backgroundColor: colors.colmenaBackground }}>
                ...
                <View alignItems = {'center'} style={{height:150, backgroundColor: colors.colmenaBackground}}>
                    <View alignItems = {'center'}>
                        <Text style={{fontSize:22, fontFamily: 'Nunito-Regular'}}>Registra tus residuos</Text>
                    </View>
                    <View alignItems = {'center'} style={{width:'80%'}}>
                        <Text style={{color: '#999999', fontSize:14, textAlign:'center', fontFamily: 'Nunito-Regular'}}>Llevá un control detallado de los residuos recuperados y coordiná su entrega </Text>
                    </View>                
