...
const TransferCoinQR = props => {
    ...
    const oneuser = props.route.params.data;
    const [valuestr, setValueStr] = useState(oneuser.requestamount);
    const [description, setDescription] = useState(oneuser.description);
