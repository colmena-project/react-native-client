...
const ActionSelector = (props) => {
  ...
  const handleTransport = () => {
    props.navigation.navigate("TransportNav");
  };
  ...
  const handleManageWaste = () => {
    props.navigation.navigate("ManageWasteNav");
  };
      ...
      <View style={styles.container}>
        ...
        <View stype={{ backgroundColor: "green" }}>
          ...
          >
            ...
            <Text style={styles.actionButtonText}>
              Transportar a Centro de Reciclado
            </Text>
            <View style={styles.actionButtonIcon} />
          </TouchableOpacity>
          ...
          >
            <Image
              ...
              source={require("../../../../assets/icons/png/icon-registrar-gestionar.png")}
            />
            <Text style={styles.actionButtonText}>Gestionar mis residuos</Text>
            <View style={styles.actionButtonIcon} />
          </TouchableOpacity>
        ...
        <View style={styles.container}>
          <Text style={styles.text}>
            Si tiene residuos para registar, elija{" "}
            <Text style={styles.boldText}>Registrar</Text>.
          </Text>
          <Text style={styles.text}>
            <Text style={styles.boldText}>Transportar</Text> si quiere
            recolectar residuos de otras personas.
          </Text>
        </View>
      </View>
    </View>
